...
export default function NoticeboardForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center px-4 py-12">
      <div
        className={`max-w-2xl w-full ${currentStyle.bg} p-8 rounded-2xl shadow-md ring-1 ${currentStyle.ring}`}
      >
        <h1
          className={`text-3xl font-bold mb-6 text-center ${currentStyle.header}`}
        >
